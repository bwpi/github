<h1 class='text-center'><?php echo $author ?></h1>
    <div class="container-fluide">
        <div class="row">
            ...
            <div class="h3 text-center" id="title">Расписание занятий в <?=$id?> классе</div>
          <div class="table-responsive">
            <table class="table table-sm table-hover table-bordered table-alert shadow-lg" id="schedule">
              <thead>
                <tr>
                  <th scope="col">#</th>
