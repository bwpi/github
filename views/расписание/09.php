...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eyedropper" viewBox="0 0 16 16">
          ...
          <div class="row btnsColor">
            <a href="<?php 
                        colorBox('000080');
                       ?>" class="aBestColor"><div class="bestColor" style="background-color: #000080"></div></a>
            <a href="<?php 
                        colorBox('00bfff');
            ...
            <a href="<?php 
                        colorBox('cd6939');
                       ?>" class="aBestColor"><div class="bestColor" style="background-color: #cd6939"></div></a>
            <a href="<?php 
                        colorBox('8b008b');
                       ?>" class="aBestColor"><div class="bestColor" style="background-color: #8b008b"></div></a>
            <a href="<?php 
                        colorBox('ffc125');
                       ?>" class="aBestColor"><div class="bestColor" style="background-color: #ffc125"></div></a>
          </div>
          <div><?=$info?></div>
          <div align="right">
