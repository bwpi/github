...
<html lang="en">
  <head>
    ...
    <title>Расписание занятий <?=str_replace(FILES, '', $_GET['id'])?> классе</title>
  </head>
  <body>
    ...
    <div class="container-fluide">
        <div class="row">
          ...
          <div class="h3 text-center" id="title">Расписание занятий <?=str_replace(FILES, '', $_GET['id'])?> классе</div>
          <div class="table-responsive">
            <table class="table table-sm table-hover table-bordered table-primary shadow-lg" id="schedule">
              <thead>
                <tr>
                  <th scope="col">#</th>
